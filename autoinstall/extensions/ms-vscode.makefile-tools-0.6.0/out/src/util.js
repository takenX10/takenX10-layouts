...
function killTree(progress, pid) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield spawnChildProcess('pgrep', ['-P', pid.toString()], getWorkspaceRoot(), true, false, stdout);
            if (!!stdoutStr.length) {
...
function cygpath(pathStr) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield spawnChildProcess("cygpath", [pathStr, "-w"], "", false, false, stdout);
        return windowsPath;
    });
}
...
function ensureWindowsPath(path) {
    return __awaiter(this, void 0, void 0, function* () {
...
function makeFullPath(relPath, curPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        fullPath = yield ensureWindowsPath(fullPath);
        return fullPath;
    });
}
...
function resolveSubstitutedPath(path) {
    return path.replace(/^\${workspace(Folder|Root)}/, getWorkspaceRoot());
}
exports.resolveSubstitutedPath = resolveSubstitutedPath;
