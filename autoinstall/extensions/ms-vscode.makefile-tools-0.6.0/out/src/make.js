        ...
        try {
            return yield vscode.window.withProgress({
                ...
                if (clean) {
                    ...
                    yield doBuildTarget(progress, "clean", clearOutput);
                }
                let retc = yield doBuildTarget(progress, target, clearOutput && !clean);
...
function doBuildTarget(progress, target, clearTerminalOutput) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield vscode.tasks.executeTask(myTask);
...
function generateParseContent(progress, cancel, forTargets = false, recursive = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield util.spawnChildProcess(configuration.getConfigurationMakeCommand(), makeArgs, util.getWorkspaceRoot(), true, true, stdout, stderr);
            clearInterval(timeout);
...
function runPreConfigureScript(progress, scriptFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield util.spawnChildProcess(runCommand, scriptArgs, util.getWorkspaceRoot(), false, false, stdout, stderr);
