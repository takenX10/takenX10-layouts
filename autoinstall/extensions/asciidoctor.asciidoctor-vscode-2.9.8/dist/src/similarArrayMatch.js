...
exports.similarArrayMatch = void 0;
 ...
 */
function similarArrayMatch(candidateItems, matchableItems) {
    ...
    if (candidateItems.length === matchableItems.length) {
        ...
        // value
        const offsets = (0, range_1.range)(-10, 10);
...
exports.similarArrayMatch = similarArrayMatch;
//# sourceMappingURL=similarArrayMatch.js.map